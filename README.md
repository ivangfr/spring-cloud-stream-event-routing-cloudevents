...
- `producer-service` Docker native image is built successfully. However, the following exception is thrown when a `news` or an `alert` is submitted
  ```
  ERROR 1 --- [ctor-http-nio-2] a.w.r.e.AbstractErrorWebExceptionHandler : [0df9a0d3-1]  500 Server Error for HTTP POST "/api/news/rai"
  ...
  Original Stack Trace:
  		...
  		at org.springframework.cloud.stream.binding.BindingService.getBinder(BindingService.java:402) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.2.5]
  		at org.springframework.cloud.stream.binding.BindingService.bindProducer(BindingService.java:277) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.2.5]
  		at org.springframework.cloud.stream.function.StreamBridge.resolveDestination(StreamBridge.java:302) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.2.5]
  		at org.springframework.cloud.stream.function.StreamBridge.send(StreamBridge.java:217) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.2.5]
  		at org.springframework.cloud.stream.function.StreamBridge.send(StreamBridge.java:171) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.2.5]
  		at org.springframework.cloud.stream.function.StreamBridge.send(StreamBridge.java:151) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.2.5]
  		...
  		at reactor.core.publisher.MonoFlatMap$FlatMapMain.onNext(MonoFlatMap.java:125) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.4.24]
  		at reactor.core.publisher.Operators$MonoSubscriber.complete(Operators.java:1816) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.4.24]
  		at reactor.core.publisher.MonoZip$ZipCoordinator.signal(MonoZip.java:251) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.4.24]
  		at reactor.core.publisher.MonoZip$ZipInner.onNext(MonoZip.java:336) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.4.24]
  		...
  		at reactor.core.publisher.Operators$MonoSubscriber.complete(Operators.java:1816) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.4.24]
  		at reactor.core.publisher.MonoFlatMap$FlatMapMain.onNext(MonoFlatMap.java:151) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:3.4.24]
  		...
  		at reactor.core.publisher.FluxMap$MapSubscriber.onComplete(FluxMap.java:144) ~[na:na]
  		at reactor.netty.channel.FluxReceive.onInboundComplete(FluxReceive.java:400) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:1.0.24]
  		at reactor.netty.channel.ChannelOperations.onInboundComplete(ChannelOperations.java:419) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:1.0.24]
  		at reactor.netty.http.server.HttpServerOperations.onInboundNext(HttpServerOperations.java:603) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:1.0.24]
  		at reactor.netty.channel.ChannelOperationsHandler.channelRead(ChannelOperationsHandler.java:113) ~[na:na]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:444) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:420) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.fireChannelRead(AbstractChannelHandlerContext.java:412) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at reactor.netty.http.server.HttpTrafficHandler.channelRead(HttpTrafficHandler.java:266) ~[na:na]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:442) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:420) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.fireChannelRead(AbstractChannelHandlerContext.java:412) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.CombinedChannelDuplexHandler$DelegatingChannelHandlerContext.fireChannelRead(CombinedChannelDuplexHandler.java:436) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.handler.codec.ByteToMessageDecoder.fireChannelRead(ByteToMessageDecoder.java:336) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.handler.codec.ByteToMessageDecoder.channelRead(ByteToMessageDecoder.java:308) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.CombinedChannelDuplexHandler.channelRead(CombinedChannelDuplexHandler.java:251) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:442) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:420) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.fireChannelRead(AbstractChannelHandlerContext.java:412) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.DefaultChannelPipeline$HeadContext.channelRead(DefaultChannelPipeline.java:1410) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:440) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:420) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.DefaultChannelPipeline.fireChannelRead(DefaultChannelPipeline.java:919) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		at io.netty.channel.nio.AbstractNioByteChannel$NioByteUnsafe.read(AbstractNioByteChannel.java:166) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:4.1.84.Final]
  		...
  		at com.oracle.svm.core.thread.PlatformThreads.threadStartRoutine(PlatformThreads.java:705) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:na]
  ...
  Caused by: java.lang.ClassNotFoundException: org.springframework.boot.autoconfigure.condition.OnBeanCondition
  	at java.lang.Class.forName(DynamicHub.java:1136) ~[com.ivanfranchin.producerservice.ProducerServiceApplication:na]
