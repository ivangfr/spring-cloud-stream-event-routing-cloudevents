...
```
ERROR 1 --- [ctor-http-nio-2] a.w.r.e.AbstractErrorWebExceptionHandler : [1a3bd1b3-1]  500 Server Error for HTTP POST "/api/alerts/weather"
...
Original Stack Trace:
		...
		at org.springframework.cloud.stream.binding.BindingService.getBinder(BindingService.java:394) ~[com.mycompany.producerservice.ProducerServiceApplication:3.2.4]
		at org.springframework.cloud.stream.binding.BindingService.bindProducer(BindingService.java:277) ~[com.mycompany.producerservice.ProducerServiceApplication:3.2.4]
		at org.springframework.cloud.stream.function.StreamBridge.resolveDestination(StreamBridge.java:296) ~[com.mycompany.producerservice.ProducerServiceApplication:3.2.4]
		at org.springframework.cloud.stream.function.StreamBridge.send(StreamBridge.java:213) ~[com.mycompany.producerservice.ProducerServiceApplication:3.2.4]
		at org.springframework.cloud.stream.function.StreamBridge.send(StreamBridge.java:170) ~[com.mycompany.producerservice.ProducerServiceApplication:3.2.4]
		at org.springframework.cloud.stream.function.StreamBridge.send(StreamBridge.java:150) ~[com.mycompany.producerservice.ProducerServiceApplication:3.2.4]
		...
		at java.lang.reflect.Method.invoke(Method.java:566) ~[com.mycompany.producerservice.ProducerServiceApplication:na]
		...
		at reactor.core.publisher.MonoFlatMap$FlatMapMain.onNext(MonoFlatMap.java:125) ~[com.mycompany.producerservice.ProducerServiceApplication:3.4.18]
		at reactor.core.publisher.Operators$MonoSubscriber.complete(Operators.java:1816) ~[com.mycompany.producerservice.ProducerServiceApplication:3.4.18]
		at reactor.core.publisher.MonoZip$ZipCoordinator.signal(MonoZip.java:251) ~[com.mycompany.producerservice.ProducerServiceApplication:3.4.18]
		at reactor.core.publisher.MonoZip$ZipInner.onNext(MonoZip.java:336) ~[com.mycompany.producerservice.ProducerServiceApplication:3.4.18]
		...
		at reactor.core.publisher.Operators$MonoSubscriber.complete(Operators.java:1816) ~[com.mycompany.producerservice.ProducerServiceApplication:3.4.18]
		at reactor.core.publisher.MonoFlatMap$FlatMapMain.onNext(MonoFlatMap.java:151) ~[com.mycompany.producerservice.ProducerServiceApplication:3.4.18]
		...
		at reactor.core.publisher.FluxMap$MapSubscriber.onComplete(FluxMap.java:144) ~[na:na]
		at reactor.netty.channel.FluxReceive.onInboundComplete(FluxReceive.java:400) ~[com.mycompany.producerservice.ProducerServiceApplication:1.0.19]
		at reactor.netty.channel.ChannelOperations.onInboundComplete(ChannelOperations.java:419) ~[com.mycompany.producerservice.ProducerServiceApplication:1.0.19]
		at reactor.netty.http.server.HttpServerOperations.onInboundNext(HttpServerOperations.java:600) ~[com.mycompany.producerservice.ProducerServiceApplication:1.0.19]
		at reactor.netty.channel.ChannelOperationsHandler.channelRead(ChannelOperationsHandler.java:93) ~[na:na]
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:379) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:365) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.fireChannelRead(AbstractChannelHandlerContext.java:357) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at reactor.netty.http.server.HttpTrafficHandler.channelRead(HttpTrafficHandler.java:266) ~[na:na]
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:379) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:365) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.fireChannelRead(AbstractChannelHandlerContext.java:357) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.CombinedChannelDuplexHandler$DelegatingChannelHandlerContext.fireChannelRead(CombinedChannelDuplexHandler.java:436) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.handler.codec.ByteToMessageDecoder.fireChannelRead(ByteToMessageDecoder.java:327) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.handler.codec.ByteToMessageDecoder.channelRead(ByteToMessageDecoder.java:299) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.CombinedChannelDuplexHandler.channelRead(CombinedChannelDuplexHandler.java:251) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:379) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:365) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.fireChannelRead(AbstractChannelHandlerContext.java:357) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		...
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:379) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.AbstractChannelHandlerContext.invokeChannelRead(AbstractChannelHandlerContext.java:365) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.DefaultChannelPipeline.fireChannelRead(DefaultChannelPipeline.java:919) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		at io.netty.channel.nio.AbstractNioByteChannel$NioByteUnsafe.read(AbstractNioByteChannel.java:166) ~[com.mycompany.producerservice.ProducerServiceApplication:4.1.77.Final]
		...
		at java.lang.Thread.run(Thread.java:829) ~[com.mycompany.producerservice.ProducerServiceApplication:na]
		at com.oracle.svm.core.thread.PlatformThreads.threadStartRoutine(PlatformThreads.java:704) ~[com.mycompany.producerservice.ProducerServiceApplication:na]
...
Caused by: java.lang.ClassNotFoundException: org.springframework.boot.autoconfigure.condition.OnBeanCondition
	at java.lang.Class.forName(DynamicHub.java:1121) ~[com.mycompany.producerservice.ProducerServiceApplication:na]
