package com.ivanfranchin.consumerservice.kafka.news;
...
import com.ivanfranchin.consumerservice.kafka.news.event.NewsEvent;
...
class NewsEventConsumerTest {
    ...
    void testCNNNewsCreated(CapturedOutput output) {
        ...
        Message<NewsEvent> newsEventMessage = CloudEventMessageBuilder
                .withData(newsEvent)
                .setType("com.ivanfranchin.producerservice.kafka.news.event.CNNNewsCreated")
    ...
    void testDWNewsCreated(CapturedOutput output) {
        ...
        Message<NewsEvent> newsEventMessage = CloudEventMessageBuilder
                .withData(newsEvent)
                .setType("com.ivanfranchin.producerservice.kafka.news.event.DWNewsCreated")
                .setHeader(PARTITION_KEY, "id")
                .build();
    ...
    void testRAINewsCreated(CapturedOutput output) {
        ...
        Message<NewsEvent> newsEventMessage = CloudEventMessageBuilder
                .withData(newsEvent)
                .setType("com.ivanfranchin.producerservice.kafka.news.event.RAINewsCreated")
                .setHeader(PARTITION_KEY, "id")
                .build();
