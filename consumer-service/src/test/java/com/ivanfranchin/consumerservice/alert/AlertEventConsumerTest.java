...
import com.ivanfranchin.consumerservice.alert.event.AlertEvent;
...
class AlertEventConsumerTest {
    ...
    void testEarthquakeAlert(CapturedOutput output) {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            Message<AlertEvent> alertEventMessage = CloudEventMessageBuilder
                    .withData(alertEvent)
                    .setType("com.ivanfranchin.producerservice.alert.event.EarthquakeAlert")
    ...
    void testWeatherAlert(CapturedOutput output) {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            Message<AlertEvent> alertEventMessage = CloudEventMessageBuilder
                    .withData(alertEvent)
                    .setType("com.ivanfranchin.producerservice.alert.event.WeatherAlert")
                    .setHeader(PARTITION_KEY, "id")
                    .build();
